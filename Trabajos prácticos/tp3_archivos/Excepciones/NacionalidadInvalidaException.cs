...
namespace Excepciones
{
    public class NacionalidadInvalidaException : Exception
    {
        ...
        public NacionalidadInvalidaException(string mensaje, string origenError) : base(mensaje)
        {
        ...
        /// <param name="origenError"></param>
        /// <param name="innerException"></param>
        public NacionalidadInvalidaException(string mensaje, string origenError, Exception innerException) : base(mensaje, innerException)
        {
            base.Source = origenError;
        }
