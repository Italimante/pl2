...
namespace Excepciones
{
    public class ArchivosException : Exception
    {
        ...
        public ArchivosException(string mensaje, string origenError) : base(mensaje)
        {
        ...
        /// <param name="origenError"></param>
        /// <param name="innerException"></param>
        public ArchivosException(string mensaje, string origenError, Exception innerException) : base(mensaje, innerException)
        {
            base.Source = origenError;
        }
